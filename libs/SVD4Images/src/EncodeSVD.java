...
/**
 * Encodes the given image file to a SVD encoded or PNG re-encoded image file.
 * 
 * <BR><BR>
...
public class EncodeSVD {
	...
	public static void main(String[] args) {
        ...
        try {
            ...
            /*
            for (int l = 0; l < formatNames.length; l++) {
                if (l == formatNames.length - 1) {
                    System.out.print(formatNames[l] + ")\n");
                } else {
                	System.out.print(formatNames[l] + ", ");
                }
            } */
            //System.out.println("or press Enter to use the default " +
            //        "(svd) encoding:");
            type = bfin.readLine();
        } catch (IOException e) {
